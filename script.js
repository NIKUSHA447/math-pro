...
// კითხვების ბაზა მე-6 კლასისთვის [cite: 2, 4]
const questions6 = [
    // რაუნდი 1: ბუნებრივი რიცხვები (3 ქულა) [cite: 13]
    { q: "ჩაწერეთ ციფრებით: სამი მილიონი ორასი ათი ათასი", a: ["3 210 000", "3 020 000", "3 200 100", "3 210"], c: 0, p: 3 }, // [cite: 33]
    { q: "რას უდრის 124-ისა და 305-ის ნამრავლი?", a: ["37 820", "38 200", "37 400", "37 878"], c: 0, p: 3 }, // [cite: 57, 327]
    ...
    // რაუნდი 2: გაყოფადობა და მამრავლები (4 ქულა) [cite: 67]
    { q: "რიცხვი იყოფა 3-ზე, თუ მისი ციფრების ჯამი იყოფა:", a: ["3-ზე", "2-ზე", "9-ზე", "6-ზე"], c: 0, p: 4 }, // [cite: 70]
    { q: "რომელ რიცხვზე იყოფა 2 340?", a: ["ყველა ჩამოთვლილზე (2,3,4,5,6,9,10)", "მხოლოდ 10-ზე", "მხოლოდ 5-ზე", "მხოლოდ 2-ზე"], c: 0, p: 4 }, // [cite: 73]
    { q: "ჩამოთვლილთაგან რომელია მარტივი რიცხვი?", a: ["17", "15", "21", "25"], c: 0, p: 4 }, // [cite: 79]
    ...
    { q: "რას უდრის უმჯ(24, 36)?", a: ["72", "48", "12", "144"], c: 0, p: 4 }, // [cite: 341]
    ...
    // რაუნდი 3: წილადები (4 ქულა) [cite: 101]
